        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="form_basic.html">室温实时数据</a>
                        </li>
                        <li><a class="J_menuItem" href="form_validate.html">区域用电趋势</a>
                        </li>
                        <li><a class="J_menuItem" href="form_advanced.html">智能开关列表</a>
                        </li>
                        <li><a class="J_menuItem" href="form_wizard.html">采集频次设置</a>
                        </li>
                        <!--<li>-->
