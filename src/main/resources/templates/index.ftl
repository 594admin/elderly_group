...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="img/logo.png" width="64px" height="64px"/></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <#--<span class="block m-t-xs"><strong class="font-bold">Beaut-zihan</strong></span>-->
                               <#--<span class="text-muted text-xs block">${personnel.preName}<b class="caret"></b></span>-->
                                <span class="text-muted text-xs block">${personnel.preName}</span>
                                </span>
                        </a>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label">户信息管理</span>
                ...
                <li>
                    <a href="#"><i class="fa fa-envelope"></i> <span class="nav-label">统计</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                ...
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">检测数据</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="#">室温实时数据</a>
                        </li>
                        <li><a class="J_menuItem" href="#">区域用电趋势</a>
                        </li>
                        <li><a class="J_menuItem" href="#">智能开关列表</a>
                        </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">Copyright &copy; 2019-2024 <a href="" target="_blank">清洁取暖智慧管理平台</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
